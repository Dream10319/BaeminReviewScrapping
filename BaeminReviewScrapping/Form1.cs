            ...
            Thread th = new Thread(new ThreadStart(() =>
            {
                ...
                for (int i = 0; i < 241; i++)
                {
                    ...
                    foreach (dynamic shop in shops)
                    {
                        ...
                        File.WriteAllText(string.Format(@"D:\Review\review{0}.json", count), strReturn1);
                        this.Invoke(new Action(() =>
                        {
                            progressBar1.Value = (int)(10000 * count / 5992);
                        }));
                    }
                }
